...
namespace IOT_PMS.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            {
                ViewBag.UserType = new SelectList(DB.Roles.Where(a => !a.Name.Contains("Admin")), "Name", "Name");
                ViewBag.RegistrationType = new SelectList(new[] { "أحادي الطور 40 أمبير", "أحادي الطور 40 أمبير", "ثلاثي الطور" });
        ...
        public ActionResult EditProfile(EditProfileViewModel profile, HttpPostedFileBase upload)
        {
            ...
            else
            {
                ...
                CurrentUser.UserName = profile.UserName;
                CurrentUser.MiddleName = profile.MiddleName;
                CurrentUser.LastName = profile.LastName;
                CurrentUser.Address = profile.Address;
                CurrentUser.Mobile = profile.Mobile;
                CurrentUser.NationalId = profile.NationalId;

                DB.SaveChanges();
                ViewBag.Message = "تمت العملية بنحاح";
            }
            return View(profile);
        }
        //
